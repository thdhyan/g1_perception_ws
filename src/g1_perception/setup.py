...
setup(
    ...
    description=(
        ...
        "/livox/mid360/points, runs the G1_sim CenterPoint detection pipeline, "
    ...
    entry_points={
        "console_scripts": [
            ...
            "centerpoint_node = g1_perception.centerpoint_node:main",
            "livox_detection_node = g1_perception.livox_detection_node:main",
            "pointpillar_node = g1_perception.pointpillar_node:main",
